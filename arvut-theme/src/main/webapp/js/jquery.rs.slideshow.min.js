...
return false;}
time+=200;setTimeout(function(){RssPrivateMethods._getImageDimensions($slideshow,$img,sucesss,timeout,onTimeout,time);},200);},_endTransition:function($slideshow,$slide){$slide.prev().fadeOut(500, $slide.prev().remove);RssPrivateMethods._trigger($slideshow,'rsPostTransition');if($slideshow.rsfSlideshow('currentSlideKey')===$slideshow.rsfSlideshow('totalSlides')-1){RssPrivateMethods._trigger($slideshow,'rsLastSlide');}
